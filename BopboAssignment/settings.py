"""
Django settings for BopboAssignment project.
...
SECRET_KEY = '!9k20m)=-+7vr@xzuu&w#09#(!i22ic(xi2ywtfriunwdnndx('
...
ROOT_URLCONF = 'BopboAssignment.urls'
...
WSGI_APPLICATION = 'BopboAssignment.wsgi.application'
